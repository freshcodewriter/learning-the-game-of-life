...
my $nexus;
my $nexus_dir = "../perl-test/NEXUS/";	## these folders need to be previously created
my $output_dir = "../perl-test/OUTPUT/";
my $PAUP_tree;
...
my $freqfile = "$PATH[0]/$PATH[1]/$PATH[2]/".$backboneFILE."_freqs.txt\n";
print "freqfile: $freqfile";
